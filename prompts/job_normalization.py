...
- ats_priority_keywords: The most important technical terms and skill keywords for ATS matching.
- posting_language: ISO 639-1 language code of the ad (e.g. "de", "en").
- contact_person_gender: If a contact person is named, determine their gender from their \
honorific (Frau/Herr/Mr./Ms./Mrs./Dr.) or from the name only when the honorific is unambiguous. \
Return "female", "male", or "unknown". Always return "unknown" when not fully confident — \
a wrong gendered salutation is far more damaging than a neutral one.""",
}
